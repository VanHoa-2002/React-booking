          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              <figure className="max-w-[200px] max-h-[200px]">
                <img src={doctoring} className="w-full" alt="" />
              </figure>
              <div>
                ...
                <div className="text__para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px]">
                  ...
                  itaque vitae deleniti qui accusantium blanditiis nobis, iusto
                  iste beatae, quis mollitia laborum quas dolorum tempora.
                  Sapiente quibusdam animi asperiores laborum!
                </div>
              </div>
            </div>
